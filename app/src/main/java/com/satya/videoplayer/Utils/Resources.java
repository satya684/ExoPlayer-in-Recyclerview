package com.satya.videoplayer.Utils;

import com.satya.videoplayer.Model.MediaObjects;

public class Resources {

    public static final MediaObjects[] MEDIA_OBJECTS = {
            new MediaObjects("Sending Data to a New Activity with Intent Extras",
            ...
            new MediaObjects("REST API, Retrofit2, MVVM Course SUMMARY",
            ...
            new MediaObjects("MVVM and LiveData",
            ...
            new MediaObjects("Swiping Views with a ViewPager",
            ...
            new MediaObjects("Database Cache, MVVM, Retrofit, REST API demo for upcoming course",
